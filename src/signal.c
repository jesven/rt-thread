...
#ifdef RT_USING_SMP
extern void _signal_return(void *);
...
#ifdef RT_USING_SMP
rt_uint8_t *rt_insert_sig_handle(rt_uint8_t *sp)
{
    /* intrrupt is disabled */
    sp = rt_hw_stack_init((void *)_signal_entry, sp,
            (void *)(sp - 32), RT_NULL);
    return sp;
}
#endif
